...
public class MainViewController implements Initializable{
	...
	private synchronized void loadView2(String absoluteName) {
		...
		try {
			...
			DepartmentListController controler = loader.getController(); //Pega a classe controller do department
			controler.setDepartmentService(new DepartmentService()); //Injetou a dependencia
			controler.updateTableView(); //Atualiza os dados na tela
